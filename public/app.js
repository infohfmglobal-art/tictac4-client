...
music.loop = true;
let musicWanted = false; // toggled by button; starts after first gesture
...
// ===== Handle move (single, clean) =====
function handleMove(r,c){
  // start bg music after first user gesture
...
// Buttons
nextBtn.addEventListener("click",()=>{ game.nextRound(); renderBoard(); updateBoard(); });
